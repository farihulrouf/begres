...
func GetAllPagu(c *fiber.Ctx) error {
	...
	return c.Status(http.StatusOK).JSON(
		responses.UserResponse{Status: http.StatusOK, Message: "success", Data: &fiber.Map{"data": pagus}},
	)
}
...
func EditPagu(c *fiber.Ctx) error {
	...
	return c.Status(http.StatusOK).JSON(responses.UserResponse{Status: http.StatusOK, Message: "success", Data: &fiber.Map{"data": updatePagu}})
}
...
func GetPagu(c *fiber.Ctx) error {
	...
	return c.Status(http.StatusOK).JSON(responses.UserResponse{Status: http.StatusOK, Message: "success", Data: &fiber.Map{"data": pagu}})
}
